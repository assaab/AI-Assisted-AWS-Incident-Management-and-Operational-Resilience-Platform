...
class PolicyEngine:
    def __init__(self) -> None:
        ...
        profile = os.getenv("POLICY_PROFILE", "demo")
        policy_root = workspace_root / "policies" / profile
        execution_file = policy_root / "execution" / "default-policy.yaml"
        approval_file = policy_root / "approval" / "rules.yaml"
